...
-- TO SELECT TRAINING DEATILS
    ...
    FROM
        ...
        LEFT JOIN hris_employee_training_assign ta ON (
                ta.training_id = ms.training_id
            AND
                ta.status = 'E'
            AND
    ...
    THEN
        ...
        THEN
            FOR i IN 0..v_duration - 1 LOOP
                IF
                    ( ( v_training_start_date + i ) <= trunc(SYSDATE) )
                THEN
                    ...
                    THEN
                        ...
                        --------LOGIC FOR 1st and 3rd sunday DO---------
                          ...
                          THEN 
                            SELECT HRIS_GET_CUSTOMIZED_DO (p_employee_id, v_training_start_date + i) INTO V_IS_DAYOFF FROM DUAL;
